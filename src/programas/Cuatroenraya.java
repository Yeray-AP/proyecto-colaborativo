...
public class Cuatroenraya {
    ...
    private static double aleatorio = Math.random(); // Al ser aleatorio como variable publica y estatica al iniciar un
                                                     // nuevo juego siempre empieza el mismo jugador
    ...
    public static void juego() {
        ...
        matriz = new int[6][7];
        contador = 0;
        // Es necesario llamar nuevamente a aleatorio y a jugador para que al empezar
        // una partida se vuelva a hacer aleatoriamente la eleccion de quien empieza
        ...
        while (contador < 42) { // Si el contador llega a 42 se ha llenado el tablero
            ...
            if (IntroducirFicha(nombre_1, nombre_2)) {
                ...
                if (jugador == jugador_aleatorio_1) { // Cambio de jugador en cada turno, solamente si se ha introducido
        ...
        if (contador == 42 && !victoria) { // La variable victoria solo se usa en este caso para en el caso de haber un
                                           // jugador que gane con la ultima ficha que no muestre un mensaje de victoria
                                           // y luego el de empate
    ...
    private static void MostarTablero() {
        for (int i = 0; i <= matriz.length; i++) { // //Para mostrar los numeros de las columnas arriba del tablero para
                                                   // que sea más visual , si tambien mostramos filas habia que añadir
                                                   // un \t al principio
            System.out.print(i + " ");
        }
        System.out.println("\n");
        ...
        for (int[] matriz1 : matriz) {
            // System.out.print(filas + "\t"); Para mostrar las filas para que sea más
            // visual para introducir las fichas, pero al solo tener que selecionar las
            // columnas no es necesario
    ...
    private static boolean comprobardiagonal() {
        ...
        // empezamos en las filas 0-2 y columnas 0-3 para que quepan 4 fichas, es decir
        // comprobamos el 4 en raya en las posiciones en las posiciones iniciales que
        // podria empezar un 4 en raya diagonal
        ...
        // Compruebo todas las diagonales ascendentes, de abajo izquierda a arriba
        // derecha
        // empezamos en las filas 3-5 y columnas 0-3 , es decir comprobamos el 4 en raya
        // en las posiciones iniciales que podria empezar un 4 en raya diagonal
