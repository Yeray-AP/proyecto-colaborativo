...
public class Cuaderno4_2{
    ...
    public static void main(String[] args) {
        ...
        while (respuesta_int != 5) {
            ...
            respuesta_int = (int) respuesta; // Hago esto para que no pete el codigo con ningun double, en caso de que
                                             // el usuario meta decimales se truncara el numero
            ...
            switch (respuesta_int) {
                ...
                case 4 -> {
                    System.out.println(
                            "El numero de victorias en el juego Buscaminas es: " + Buscaminas.partidas_ganadas);
                    System.out.println(
                            "El numero de victorias en el juego Hundir la flota es: " + Hundirlaflota.partidas_ganadas);
                    System.out.println("");
                }
                case 5 -> {
                    break;
